  ...
  return (
    <footer className="bg-white p-4 mt-8">
      <div className="container mx-auto flex justify-between items-center">
        {/* Copyright */}
        <p className=" text-black">&copy; {new Date().getFullYear()} All Rights Reserved</p>

        {/* Social Media Links */}
        <div className="pb-5 pr-28">
          <div className=" text-black text-center py-5 font-bold">Participating Members:</div>
        ...
        <Link href="#top" className=''> <img src="/Back-to-top.png" alt="Back to top" className='w-12 h-12 mx-4' /></Link>
      </div>
      <hr/>
      <p className=" text-center text-black pt-3">Designed and Implemented by <a href="https://github.com/202306-NEA-DZ-FEW/e-commerce-project-team-8" className="text-blue-500 hover:text-blue-700">Team-8</a></p>
    </footer>
  );
};
